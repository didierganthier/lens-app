...
export default function Navbar() {
    ...
    return (
        <nav className='h-16 w-full shadow-md flex justify-between fixed z-10'>
            <div className='flex w-[40%] h-full'>
                <Link href="/">
                    <a className='rounded-full'>
                        <img className='h-10 w-auto mt-3 mx-2  md:mx-10 rounded-full' src='/lens.png' alt='The Spot Events' />
                    </a>
                </Link>
            ...
            <div className='md:flex justify-start w-[35%] h-full text-sm hidden'>
                ...
                <div className='py-3 px-2'>
                    <Dropdown title='Connect Wallet' chevron={false} />
                </div>
